...
if status is-login
  ...
  set -U fzf_preview_dir_cmd  exa --icons --group-directories-first --git -TL1
  set -U fzf_preview_file_cmd bat --style 'changes' --color=always
  set -U fzf_fd_opts          -H --ignore-file ~/.fdignore
